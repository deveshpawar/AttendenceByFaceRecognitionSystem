...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\student1.jpg")  # type: ignore
        img=img.resize((500,130),Image.LANCZOS) # type: ignore
        ...
        img1=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\student2.jpg") # type: ignore
        img1=img1.resize((500,130),Image.LANCZOS) # type: ignore
        ...
        #THIRD IMAGE
        img2=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\student3.jpg")  # type: ignore
        img2=img2.resize((500,130),Image.LANCZOS) # type: ignore
        ...
        img3=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\images.jpg")  # type: ignore
        img3=img3.resize((1530,710),Image.LANCZOS) # type: ignore
        ...
        img_left=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\student3.jpg")  # type: ignore
        img_left=img_left.resize((720,130),Image.LANCZOS) # type: ignore
        ...
        #department
        dep_label=Label(current_course_frame,text="Deparement",font=("times new roman",12,"bold"))
        ...
        dep_combo["values"]=("Select Department","Artificial Intelligence","IT","Civil","Mechinical")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","CADD","BEEE","Physics","Applied Calculus")
        ...
        roll_no_entry=ttk.Entry(class_Student_frame,textvariable=self.var_address,width=20,font=("times new roman",13,"bold"))
        roll_no_entry.grid(row=4,column=1,padx=10,pady=5,sticky=W)
        ...
        img_right=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\student3.jpg")  # type: ignore
        img_right=img_right.resize((720,130),Image.LANCZOS) # type: ignore
        ...
        self.student_table=ttk.Treeview(table_frame,column=('dep','course','year','sem','id','name','div','roll','gender','dob','email','phone','address','teacher','photo'),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set) # type: ignore
    ...
    def get_cursor(self,event=""):
        ...
        self.var_dep.set(data[0]),# type: ignore
        self.var_course.set(data[1]),# type: ignore
        self.var_year.set(data[2]),# type: ignore
        self.var_semester.set(data[3]),# type: ignore
        self.var_std_id.set(data[4]),# type: ignore
        self.var_std_name.set(data[5]),# type: ignore
        self.var_div.set(data[6]),# type: ignore
        self.var_roll.set(data[7]),# type: ignore
        self.var_gender.set(data[8]),# type: ignore
        self.var_dob.set(data[9]),# type: ignore
        self.var_email.set(data[10]),# type: ignore
        self.var_phone.set(data[11]),# type: ignore
        self.var_address.set(data[12]),# type: ignore
        self.var_teacher.set(data[13]),# type: ignore
        self.var_radio1.set(data[14])# type: ignore
