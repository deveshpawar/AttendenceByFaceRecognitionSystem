...
class Attendence:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\attendence_part.png")  # type: ignore
        img=img.resize((800,200),Image.LANCZOS) # type: ignore
        ...
        img1=Image.open(r"C:\Users\deves\OneDrive\Desktop\FaceRecog\collect_images\attendence_part_1.png") # type: ignore
        img1=img1.resize((800,200),Image.LANCZOS) # type: ignore
        ...
        title_lbl=Label(bg_img,text="STUDENT ATTENDENCE SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="green")        
        ...
        #atten_attendence=ttk.Entry(left_inside_frame,width=22,font='comicsansns 11 bold')
        #atten_attendence.grid(row=1,column=1,pady=8) 
        ...
        self.AttendenceReportTable=ttk.Treeview(table_frame,column=("id","roll","name","department","time","date","attendence"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set) # type: ignore
       ...
       # self.AttendenceReportTable.heading("attendance",text="Attendence")
        ...
        self.AttendenceReportTable.bind("<ButtonRelease>",self.get_cursor) # type: ignore
    ...
    def fetchData(self,rows):
      ...
      #to import attendence sheet      
    def importCsv(self):
        global mydata
        mydata.clear()
        fln=filedialog.askopenfilename(initialdir=os.getcwd(),title="Open CSV",filetypes=(("CSV File","*.csv"),("All File","*.*")),parent=self.root) # type: ignore
    ...
    def exportCsv(self):
        try:
            if len(mydata)<1:
                ...
                return False
            fln=filedialog.asksaveasfilename(initialdir=os.getcwd(),title="Open CSV",filetypes=(("CSV File","*.csv"),("All File","*.*")),parent=self.root) # type: ignore
